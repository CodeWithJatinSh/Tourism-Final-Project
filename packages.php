<section class="page-section bg-dark" id="home">
	...
	<div class="w-100">
		...
		/* Fetching packages data and create a card is created with an image, package title, star rating, package 
	       description, and price. The star rating is calculated based on the average rating of 
...
<!-- 
	...
	This is a PHP code block that generates a section of HTML code for displaying tour packages. 
	The section has a dark background and an ID of "home".

    Within the section, there is a container with a centered heading "Tour Packages", and a 
	horizontal line underneath it.

    The PHP code uses a MySQL query to fetch all tour packages from the database, and then 
	loops through each package to display its information using HTML and CSS.

    For each package, a card is created with an image, package title, star rating, package 
	description, and price. The star rating is calculated based on the average rating of 
	reviews for the package.

    At the bottom of each card, there is a button to view more details about the package, 
	which links to another page with additional information.
